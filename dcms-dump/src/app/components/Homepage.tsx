            ...
            <div>
              ...
              <div className="mt-8 grid grid-cols-3 gap-8">
                ...
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-700">Star Rating</div>
                </div>
              </div>
            </div>
                ...
                <CardContent className="p-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-700">Emergency Care</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
      ...
      <section id="booking-form" className="py-16 bg-gradient-to-br from-blue-50 to-indigo-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700">Quick and easy scheduling - we'll contact you within 24 hours</p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700">We're committed to providing exceptional dental care</p>
          </div>
      ...
      <section id="services" className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700">Comprehensive dental care for the whole family</p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-gray-700">(555) 123-DENTAL</div>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-gray-700">info@gogoyagoy.com</div>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-gray-700">123 Dental Plaza<br />Your City, State 12345</div>
                  </div>
                </div>
