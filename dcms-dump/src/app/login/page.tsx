      ...
      <div className="max-w-md w-full space-y-8">
            ...
            <Card className="bg-CustomPink2 border-2 border-grey-50">
              ...
              <CardContent>
                <form onSubmit={handleSignUp} className="space-y-4">
                  <div className="space-y-2">
                    <Label htmlFor="signup-name"><strong>User Name</strong></Label>
                    <Input
                      className= "bg-CustomPink3 border-CustomPink1 border-2"
                      id="signup-name"
                      type="text"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="signup-password"><strong>Password</strong></Label>
                    <div className="relative">
                      <Input
                        className= "bg-CustomPink3 border-CustomPink1 border-2"
                        id="signup-password"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="signup-confirm-password"><strong>Confirm Password</strong></Label>
                    <div className="relative">
                      <Input
                        className= "bg-CustomPink3 border-CustomPink1 border-2"
                  ...
                  {signUpData.password && (
                    <div className="space-y-2">
                      <Label className="text-sm text-CustomPink1"><strong>Password Requirements:</strong></Label>
                  ...
                  <Button type="submit" className="w-full" variant="default_pink" disabled={isLoading || !isSignUpFormValid}>
        ...
        <div className="text-center">
          <Button
            variant="ghost" 
            onClick={() => router.push('/')}
            className="text-sm text-CustomPink1"
          >
